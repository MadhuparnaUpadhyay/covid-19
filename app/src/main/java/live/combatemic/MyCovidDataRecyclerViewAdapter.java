 ...
 * specified {@link CovidDataFragment.OnListFragmentInteractionListener}.
...
public class MyCovidDataRecyclerViewAdapter extends RecyclerView.Adapter<MyCovidDataRecyclerViewAdapter.ViewHolder> {
    ...
    public MyCovidDataRecyclerViewAdapter(JSONArray statewise, JSONObject citywise, CovidDataFragment.OnListFragmentInteractionListener mListener) {

...
public class CityExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    public CityExpandableListAdapter(Context mContext, JSONArray statewise, JSONObject citywise, StateDetailsFragment.OnListFragmentInteractionListener mListener) {
...
//            return 0;
    ...
    public View getChildView(int groupPosition, final int childPosition,
        ...
        if (convertView == null) {
            ...
            convertView = infalInflater.inflate(R.layout.fragment_state_item_list, null);
        }

//        if (childPosition == 0)
//            return convertView = infalInflater.inflate(R.layout.fragment_state_details_item, null);
    ...
    public View getGroupView(int groupPosition, boolean isExpanded,
        ...
        if (convertView == null) {
            LayoutInflater infalInflater = (LayoutInflater) this.mContext
                    .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            convertView = infalInflater.inflate(R.layout.fragment_state_details_group, null);
        }

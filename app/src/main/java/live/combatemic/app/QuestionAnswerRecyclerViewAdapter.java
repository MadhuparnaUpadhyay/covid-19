...
import live.combatemic.app.QuestionAnswerFragment.OnListFragmentInteractionListener;
...
public class QuestionAnswerRecyclerViewAdapter extends RecyclerView.Adapter<QuestionAnswerRecyclerViewAdapter.ViewHolder> {
    ...
    public QuestionAnswerRecyclerViewAdapter(List<QuestionAnswer.QuestionAnswerModel> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
